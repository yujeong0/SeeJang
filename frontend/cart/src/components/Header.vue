<template>
    <div id="container">
        <v-toolbar class="nav" style="height: 45px">
            <v-toolbar-title class="grey--text lastObject" style="margin-left:-2%; margin-top:-3%">
                <label >장보기</label>
            </v-toolbar-title>
            <v-btn text @click="changeMode" class="mode" style="padding: 0; margin-left: 3%; margin-top:-3%">
                모드변경
        ...
        <div class="gridDiv">
            <v-row no-gutters>
                ...
                <v-col @click="popular_product"
                    ><img src="@/assets/populer.png/" alt="" width="60px" class="ml-4 mr-4"
                /></v-col>
                <v-col @click="camera"
        ...
        <div class="gridDiv mb-2">
            <v-row no-gutters>
                ...
                <v-col class="selected" @click="popular_product"
                    ><span style="font-size: small" class="ml-3 mr-3">이번주 상품</span></v-col
                >
                <v-col class="selected" @click="camera"
                    ><span style="font-size: small" class="ml-6 mr-3">상품찾기</span></v-col
                >
            </v-row>
        </div>
        <hr class="first" />
