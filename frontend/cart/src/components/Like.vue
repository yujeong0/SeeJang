  ...
  <div id="container">
    <div style="text-align: left" class="pl-4 my-1 target ml-3 mr-3">
        ...
        <div class="productPrice" style="text-align: right">
          {{ like.price }}원
          <v-btn text outlined @click="del" style="margin-left:7px; width:3%">_
...
export default {
  ...
  methods: {
    async del() {
      ...
      let wishNo = parseInt(this.like.wishNo);
      formData.append("wishNo",wishNo);
            await http.post("/wishList/remove", formData ,{
