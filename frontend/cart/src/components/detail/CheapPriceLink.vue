<template>
     <div id="container">
          <h3 class="text-h7 mt-4 pr-1" style="border: 1px solid white">최저가 링크</h3>
          ...
          <v-row>
               ...
               <v-col style="text-align: right; padding-right: 30px">
                    <a target="_blank" :href="$store.getters.getReviewLink">이마트몰리뷰</a></v-col
               >
          </v-row>
          <hr />
                         ...
                         <v-row no-gutters>
                              ...
                              >
                                   <v-col style="margin-top: -15px">
                                        <v-btn text color="blue" @click="updateReview(i)"
                                             >수정</v-btn
                                        >
                                   </v-col>
                                   <v-col style="margin-top: -15px">
