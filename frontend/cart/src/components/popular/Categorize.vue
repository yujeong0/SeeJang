<template>
    <div>
        <div class="gridDiv" id="container">
            <v-row no-gutters>
                ...
                <v-col @click="clickCategory('냉장/냉동')"
                    ><img src="@/assets/instant.png/" alt="" width="40px" class="ml-4 mr-4"
                /></v-col>
                <v-col
                    ><img
        ...
        <div class="gridTextDiv">
            <v-row no-gutters>
                <v-col style="font-size: small" class="mr-2" @click="clickCategory('과일')"
                    >과일</v-col
                >
                <v-col style="font-size: small" class="ml-2 mr-2" @click="clickCategory('커피/차')"
                    >커피/차</v-col
                >
                <v-col
                    ...
                    >냉장/냉동</v-col
                >
                <v-col style="font-size: small" class="ml-2" @click="clickCategory('생수/음료')"
                    >생수/음료</v-col
                >
            </v-row>
        </div>
